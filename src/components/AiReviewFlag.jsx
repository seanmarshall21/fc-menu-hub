...
export default function AiReviewFlag({ state }) {
  ...
  return (
    <span className="inline-flex items-center gap-0.5 flex-shrink-0" title="AI review complete">
      <span className="w-[18px] h-[18px] rounded-full inline-flex items-center justify-center bg-purple-600 text-white">
