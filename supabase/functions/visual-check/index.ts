...
with the list, AND flag any listed item that does NOT appear on the menu —
missing items are important to catch. Before deciding an item is missing, scan
the ENTIRE image, including small print and any secondary section at the very
bottom (e.g. an "NA" / non-alcoholic / add-ons row, or a single last line). If,
after that careful scan, an item genuinely doesn't appear anywhere, report it.
